...
export const post2: BlogPost = {
  ...
  title: "How Many Shirts Should You Own? The Washing Machine Dilemma",
  author: "Ali Zindari",
  date: "2026-08-08",
  excerpt: "",
  ...
  difficulty: 2,
  content: String.raw`Recently, I've been thinking about a problem I have to deal with every week. There isn't a washing machine in my apartment. There is just one for the whole building, and everyone shares it. Each wash costs 1.25 €.
...
The expected-cost derivation tells us what should be optimized and why. The simulator below carries out the remaining discrete search, runs the random process repeatedly, and compares both average cost and shortage risk.`
};
