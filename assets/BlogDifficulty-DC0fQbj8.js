...
`},y=[c,d,l],m={1:"Easy",2:"Introductory",3:"Intermediate",4:"Advanced",5:"Research-level"},f=["#2a9d8f","#69a85d","#d4a72c","#df713f","#c3454f"],g=({level:t,className:n})=>{const a=m[t];return e.jsxs("div",{className:r("border-y border-border/80 py-3",n),"aria-label":`Difficulty: ${a}, ${t} out of 5`,title:`Difficulty: ${a} (${t}/5)`,children:[e.jsxs("div",{className:"flex items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-2 text-sm font-medium text-foreground",children:[e.jsx(h,{size:17,className:"shrink-0 text-muted-foreground","aria-hidden":"true"}),e.jsx("span",{children:"Technical difficulty"})]}),e.jsxs("div",{className:"flex shrink-0 items-baseline gap-2",children:[e.jsx("span",{className:"text-sm font-semibold text-foreground",children:a}),e.jsxs("span",{className:"text-xs tabular-nums text-muted-foreground",children:[t,"/5"]})]})]}),e.jsxs("div",{className:"mt-3","aria-hidden":"true",children:[e.jsx("div",{className:"relative grid h-2.5 grid-cols-5 gap-1",children:f.map((s,i)=>e.jsx("span",{className:"rounded-[2px] transition-all duration-300",style:{backgroundColor:s,opacity:i<t?1:.18,transform:i===t-1?"scaleY(1.45)":void 0,boxShadow:i===t-1?`0 0 0 2px hsl(var(--background)), 0 0 0 3px ${s}`:void 0}},s))}),e.jsxs("div",{className:"mt-2 flex justify-between text-[11px] text-muted-foreground",children:[e.jsx("span",{children:"Easy"}),e.jsx("span",{children:"Hard"})]})]})]})};export{g as B,y as b};
